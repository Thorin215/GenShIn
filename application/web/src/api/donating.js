...
export function queryDonatingList(data) {
  return request({
    url: 'http://localhost:8888/api/v1/queryDonatingList',
    method: 'post',
    headers: {
...
export function queryDonatingListByGrantee(data) {
  return request({
    url: 'http://localhost:8888/api/v1/queryDonatingListByGrantee',
    method: 'post',
    headers: {
      'Content-Type': 'application/json'
    },
...
export function updateDonating(data) {
  return request({
    url: 'http://localhost:8888/api/v1/updateDonating',
    method: 'post',
    headers: {
      'Content-Type': 'application/json'
    },
...
export function createDonating(data) {
  return request({
    url: 'http://localhost:8888/api/v1/createDonating',
    method: 'post',
    headers: {
      'Content-Type': 'application/json'
    },
